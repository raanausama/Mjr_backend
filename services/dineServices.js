...
exports.Restaurant1 = (req, res) => {
    upload.single("image")(req, res, (err) => {
      ...
      const sql =
        "UPDATE home SET rest1_img = ?,  rest1_title = ?, rest1_txt= ? WHERE username = ?";
      pool.query(sql, [imagePath, title, text, username], (err, result) => {
        if (err) {
          console.error("Error inserting image path:", err);
          res.status(500).send("Error inserting image into the database.");
  ...
  exports.Restaurant2 = (req, res) => {
    upload.single("image")(req, res, (err) => {
      ...
      const sql =
        "UPDATE home SET rest2_img = ?,  rest2_title = ?, rest2_txt= ? WHERE username = ?";
      pool.query(sql, [imagePath, title, text, username], (err, result) => {
        if (err) {
          console.error("Error inserting image path:", err);
          res.status(500).send("Error inserting image into the database.");
  ...
  exports.Restaurant3 = (req, res) => {
    upload.single("image")(req, res, (err) => {
      ...
      const sql =
        "UPDATE home SET rest3_img = ?,  rest3_title = ?, rest3_txt= ? WHERE username = ?";
      pool.query(sql, [imagePath, title, text, username], (err, result) => {
        if (err) {
          console.error("Error inserting image path:", err);
          res.status(500).send("Error inserting image into the database.");
  ...
  exports.Restaurant4 = (req, res) => {
    upload.single("image")(req, res, (err) => {
      ...
      const sql =
        "UPDATE home SET rest4_img = ?,  rest4_title = ?, rest4_txt= ? WHERE username = ?";
      pool.query(sql, [imagePath, title, text, username], (err, result) => {
        if (err) {
          console.error("Error inserting image path:", err);
          res.status(500).send("Error inserting image into the database.");
  ...
  exports.Restaurant5 = (req, res) => {
    upload.single("image")(req, res, (err) => {
      ...
      const sql =
        "UPDATE home SET rest5_img = ?,  rest5_title = ?, rest5_txt= ? WHERE username = ?";
      pool.query(sql, [imagePath, title, text, username], (err, result) => {
        if (err) {
          console.error("Error inserting image path:", err);
          res.status(500).send("Error inserting image into the database.");
