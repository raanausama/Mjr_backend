...
exports.Hero = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    // const sql ="INSERT into Activities (hero_img, username) VALUES (?,?)"
...
exports.Card1 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET card1_img = ?,  card1_title = ?, card1_txt= ? WHERE username = ?";
...
exports.Card2 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET card2_img = ?,  card2_title = ?, card2_txt= ? WHERE username = ?";
...
exports.Card3 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET card3_img = ?,  card3_title = ?, card3_txt= ? WHERE username = ?";
...
exports.Activities1 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET ac1_img = ?,  ac1_title = ?, ac1_txt= ? WHERE username = ?";
    pool.query(sql, [imagePath, title, text, username], (err, result) => {
      if (err) {
        console.error("Error inserting image path:", err);
        res.status(500).send("Error inserting image into the database.");
...
exports.Activities2 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET ac2_img = ?,  ac2_title = ?, ac2_txt= ? WHERE username = ?";
    pool.query(sql, [imagePath, title, text, username], (err, result) => {
      if (err) {
        console.error("Error inserting image path:", err);
        res.status(500).send("Error inserting image into the database.");
...
exports.Activities3 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET ac3_img = ?,  ac3_title = ?, ac3_txt= ? WHERE username = ?";
    pool.query(sql, [imagePath, title, text, username], (err, result) => {
      if (err) {
        console.error("Error inserting image path:", err);
        res.status(500).send("Error inserting image into the database.");
...
exports.Activities4 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET ac4_img = ?,  ac4_title = ?, ac4_txt= ? WHERE username = ?";
    pool.query(sql, [imagePath, title, text, username], (err, result) => {
      if (err) {
        console.error("Error inserting image path:", err);
        res.status(500).send("Error inserting image into the database.");
...
exports.Activities5 = (req, res) => {
  upload.single("image")(req, res, (err) => {
    ...
    const sql =
      "UPDATE activities SET ac5_img = ?,  ac5_title = ?, ac5_txt= ? WHERE username = ?";
    pool.query(sql, [imagePath, title, text, username], (err, result) => {
      if (err) {
        console.error("Error inserting image path:", err);
        res.status(500).send("Error inserting image into the database.");
